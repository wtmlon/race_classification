...
data_dir = 'F:\\Race_Classification\RACE_IMG1'
...
dataloaders = {x: DataLoader(image_datasets[x], batch_size=40,
						shuffle=True, 
						num_workers=0)
					for x in ['train', 'val']}
...
exp_lr_scheduler = lr_scheduler.StepLR(optimizer_r18, step_size=20, gamma=0.1)
...
torch.save(model_r18.state_dict(), 'F:\\Race_Classification\\Race_Classification\\model\\')
